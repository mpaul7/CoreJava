 ...
 * O2 = (b)O1
 * b O1 = (b)new a();
 * Casting is legal at compile time error at run time
 *  This is possible if O1 must contain the object of b only or any of the sub class, i.e.
 *  a O1 = new b();
 *  b O2 = new b();
 *  O2 = (b) O1. 
 *Note: now is has reference of class b, earlier u it was object of class b but refernce  was of class a. 
